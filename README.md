...
- NODO Earth Time: serie de hasta 12 escenas en 90 días, calidad SCL por lote, curva de NDVI/NDMI, lluvia diaria de Open-Meteo Archive, mediana empírica del polígono y CSV de observaciones persistidas.
- NODO Water: saldo de referencia por lote (lluvia + riego declarado − ET0 FAO‑56), bitácora append-only de riego, NDMI/suelo como evidencia y recorrida dirigida sin prescribir lámina.
...
- NODO Scout Field: análisis estructural de políglotas y consulta de hash en catálogos públicos antes de adjuntar evidencia; la foto no se envía y no se habilitan archivos arbitrarios.
...
El contrato para integrar hardware está en [`docs/IOT_GATEWAY.md`](docs/IOT_GATEWAY.md), el trabajo cifrado sin señal en [`docs/FIELD_OFFLINE.md`](docs/FIELD_OFFLINE.md), el uso de recorridas en [`docs/SCOUTING_PROTOCOL.md`](docs/SCOUTING_PROTOCOL.md), el análisis de evidencia en [`docs/SCOUT_FIELD.md`](docs/SCOUT_FIELD.md), la serie satelital en [`docs/EARTH_TIME.md`](docs/EARTH_TIME.md), el saldo hídrico en [`docs/WATER.md`](docs/WATER.md), el relieve DEM en [`docs/TERRAIN.md`](docs/TERRAIN.md), el circuito de resultados en [`docs/OUTCOME_LEDGER.md`](docs/OUTCOME_LEDGER.md), la administración de acceso en [`docs/TEAM_OPERATIONS.md`](docs/TEAM_OPERATIONS.md), la medición comercial en [`docs/PILOT_CONTROL.md`](docs/PILOT_CONTROL.md), el plan de compañía en [`docs/PRODUCT_ROADMAP.md`](docs/PRODUCT_ROADMAP.md), la diferenciación en [`docs/COMPETITIVE_STRATEGY.md`](docs/COMPETITIVE_STRATEGY.md) y los gates regulatorios y de protección en [`docs/LAUNCH_READINESS.md`](docs/LAUNCH_READINESS.md).
