...
- Bóveda offline v2 ensayada en el dispositivo de campo objetivo: hallazgo y foto real, bloqueo, corte de red, reinicio, reconexión, pausa/reanudación TUS, rechazo por permiso/estado, sincronización idempotente, hash coincidente, cuota/evicción y procedimiento por frase perdida. La implementación binaria existe, pero este gate no se supera hasta registrar ese ensayo físico y el análisis antimalware definido para archivos no controlados.
