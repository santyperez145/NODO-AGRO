...
import { Activity, Beef, Bot, CloudRain, Database, Gauge, HardDrive, KeyRound, Leaf, LoaderCircle, LogOut, Map, Pencil, Radio, RefreshCw, Satellite, ScanSearch, ShieldAlert, ShieldCheck, Target, Tractor, TrendingUp, Users, Wifi, WifiOff } from 'lucide-react';
...
const sections = [[Gauge,'Centro de mando'],[Map,'Mapa vivo'],[Leaf,'Cultivos'],[ScanSearch,'Recorridas'],[Beef,'Rodeo'],[Tractor,'Maquinaria'],[Radio,'Sensores'],[TrendingUp,'Economía'],[Target,'Piloto'],[Users,'Equipo']] as const;
